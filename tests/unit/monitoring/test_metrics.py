"""Unit tests for infra_monitoring.services.monitoring.metrics.
...
def test_collect_metrics_smoke():
    ...
    mod = importlib.reload(importlib.import_module("infra_monitoring.services.monitoring.metrics"))
...
def test_export_some_metrics_with_prom(monkeypatch):
    ...
    exporter_mod = importlib.import_module("infra_monitoring.api.exporter.prometheus")
