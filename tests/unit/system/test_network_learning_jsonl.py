...
def test_record_daily_usage_overwrites_and_appends(tmp_path):
    ...
    assert isinstance(entry1.get("bytes_sent"), int) and entry1["bytes_sent"] == 100
    assert isinstance(entry1.get("bytes_recv"), int) and entry1["bytes_recv"] == 200
    ...
    assert isinstance(entry1b, dict)
    assert isinstance(entry1b.get("bytes_sent"), int) and entry1b["bytes_sent"] == 300
    assert isinstance(entry1b.get("bytes_recv"), int) and entry1b["bytes_recv"] == 400
    ...
    assert isinstance(entry2.get("bytes_sent"), int) and entry2["bytes_sent"] == 500
    assert isinstance(entry2.get("bytes_recv"), int) and entry2["bytes_recv"] == 600
    ...
    assert isinstance(entry2b, dict)
    assert isinstance(entry2b.get("bytes_sent"), int) and entry2b["bytes_sent"] == 700
    assert isinstance(entry2b.get("bytes_recv"), int) and entry2b["bytes_recv"] == 800
