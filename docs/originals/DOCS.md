...
A galeria compacta com miniaturas está disponível abaixo; clique em qualquer imagem para abri-la em tamanho real. Se preferir, abra `prints/README.md` para a mesma galeria embutida na pasta das imagens.

... (conteúdo omitido nesta cópia de backup) ...
